...
class LoginView:
    ...
    def _initialize(self):
        ...
        newbutton = ttk.Button(master=self._root, text="Create User", command=self._handle_createuser_click)
        ...
        newbutton.grid(row = 4, column = 1, sticky=(constants.E, constants.W), padx = 30)
