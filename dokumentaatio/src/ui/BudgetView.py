...
class CreateUserView:
    ...
    def _initialize(self):
        ...
        button = ttk.Button(master=self._root, text="Create User", command=self._handle_button_click)
        ...
        self.password_entry2.grid(row = 3, column = 1, sticky =(constants.E, constants.W), padx = 30, pady = 5)
        button.grid(row = 4, column = 1, sticky=(constants.E, constants.W), padx = 30)
